          ...
          <div className="bg-gradient-card border border-border/50 rounded-2xl p-8 max-w-4xl mx-auto shadow-card">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a 
                ...
                className="inline-flex items-center justify-center px-8 py-3 bg-gradient-secondary text-secondary-foreground font-poppins font-semibold rounded-lg hover:shadow-neon-green transition-all duration-300 transform hover:scale-105"
              >
                📞 Call Now
              </a>
            </div>
